...
когда объекты класса ObjList связаны с соседними через приватные свойства __next и __prev: (тут схема двусвязного списка.)
...
class LinkedList:
    ...
    def remove_obj(self):
        if self.tail is None:
            return
        t_prev = self.tail.get_prev()
        if t_prev:
            t_prev.set_next(None) 
